...
!! vacuum potential given as input file. The graph is displaced so that
!! V(Rmin)=0. If no name is given as output file, information will be printed
